...
if(usrInput ==='C'){
    //Thêm sp mới vào cart = câu lệnh promt
    //nối chuỗi in ra console string cart= +
    //in ra console
}else if(usrInput === 'R'){
    //B1: in ra conlse string cart
}else if(usrInput==='C'){
    //B1:sd câu lệnh prompt() cho ng dùng nhập vào item muốn update
    //B2: Sử dụng lệnh prompt() cho ng dùng nhập vào item mới
    //B3: In ra màn hìn console string cart sau update
}else if(usrInput === 'D'){

    //B1: Sử dụng câu lệnh prompt() cho ng dùng nhập vào item muốn xoá
    //B2: xáo và in ra string cart sau khi đc xoá
}else if(usrInput ==='E'){
    //Dừng ctrinh
}